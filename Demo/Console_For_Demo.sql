...
-- Partitioning (partities)
CREATE INDEX name ON students USING BTREE (name);
CREATE INDEX name ON students USING HASH (name);
CREATE INDEX name ON students USING GIST (name);
CREATE INDEX name ON students USING SPGIST (name);
CREATE INDEX name ON students USING GIN (name);
CREATE INDEX name ON students USING BRIN (name);
